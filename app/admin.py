...
def _hub_config():
    ...
    return {
        ...
        'site_name': (_setting('site_name', current_app.config.get('SITE_NAME', 'Portal Trivox')) or '').strip(),
...
def save_footer_social():
    ...
    _save_setting("footer_copyright_text", (request.form.get("footer_copyright_text", "") or "").strip() or "© 2026 Portal Trivox. Todos os direitos reservados.")
...
def save_identity():
    ...
    _save_setting("site_name", (request.form.get("site_name", "") or "").strip() or current_app.config.get("SITE_NAME", "Portal Trivox"))
